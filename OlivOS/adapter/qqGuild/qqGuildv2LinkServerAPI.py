...
@File      :   OlivOS/qqGuildv2LinkServerAPI.py
...
class server(OlivOS.API.Proc_templet):
        ...
        try:
            ...
            if tmp_data_rx_obj.data.op == 0:
                if tmp_data_rx_obj.data.t in [
                    ...
                    sdk_event = OlivOS.qqGuildv2SDK.event(
    ...
    def on_error(self, ws, error):
        self.log(
            0,
            "OlivOS qqGuild link server [" + self.Proc_name + "] websocket link error",
        )
    ...
    def on_open(self, ws):
        self.log(
            2,
            "OlivOS qqGuild link server [" + self.Proc_name + "] websocket link start",
        )
    ...
    def run_pulse(self):
        ...
        self.log(
            0,
            "OlivOS qqGuild link server [" + self.Proc_name + "] websocket pulse lost",
        )
        return
    ...
    def run_websocket_rx_connect_start(self):
        ...
        self.log(
            2, "OlivOS qqGuild link server [" + self.Proc_name + "] websocket link lost"
        )
