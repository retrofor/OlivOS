...
dictMessageType = {
    "wechat": {
        "onebot": {"onebotV12": "obv12_para", "ComWeChatBotClient": "obv12_para"}
    },
    "qq": {
        "onebot": {
            "default": "old_string",
    ...
    "hackChat": {
        "hackChat_link": {"default": "olivos_string", "private": "olivos_string"}
    },
    "biliLive": {
            ...
            for data_raw_this in self.data_raw:
                if (
                    ...
                    if (
                        ...
                        tmp_data.append(
                            PARA.reply(str(data_raw_this["data"]["message_id"]))
                        )
                    elif (
            ...
            if tmp_data_type == "string" and self.match_str(
                ...
                if it_data_this > it_data_base:
                    ...
                    for tmp_code_data_list_this in tmp_code_data_list:
                        ...
                        tmp_code_data_dict[tmp_code_data_list_this_key] = (
                            tmp_code_data_list_this_val
                        )
...
class PARA(object):
    ...
    class video(PARA_templet):
        def __init__(self, file, url=None, cache=None, proxy=None, timeout=None):
            PARA_templet.__init__(
                self, "video", self.data_T(file, url, cache, proxy, timeout)
            )
